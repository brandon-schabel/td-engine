...
import { Button } from "@/ui/react/components/shared/Button";
      ...
      <div className="relative z-10 w-full h-full flex flex-col">
        ...
        <div className="flex items-center justify-between p-6 bg-black/30 backdrop-blur-sm border-b border-white/10">
          <div className="flex items-center gap-3">
            <div className="drop-shadow-[0_0_20px_rgba(255,215,0,0.6)] animate-pulse">
              ...
              <div className="flex gap-1">
                {[
                  ...
                  <Button
                    key={filter.value}
                    variant={
                      currentFilter === filter.value ? "primary" : "ghost"
                    }
                    size="sm"
              ...
              <div className="divide-y divide-ui-border-DEFAULT">
                ...
                {filteredLeaderboard.length === 0 ? (
                  <div className="p-12 text-center">
                    ...
                    <p className="text-xl text-ui-text-secondary">
                      No entries yet
                    </p>
                    <p className="text-lg text-button-primary mt-2">
                  ...
                  filteredLeaderboard.map((entry) => (
                    <div
                      ...
                      className={cn(
                        ...
                        entry.rank <= 3 &&
                          "hover:translate-x-1 hover:shadow-[inset_4px_0_0_0_#ffd700]"
                      )}
                    >
                      {/* Rank */}
