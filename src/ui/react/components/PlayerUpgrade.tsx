...
} from "@/config/PlayerUpgradeConfig";
  ...
  return (
    <div className="px-4 pt-4 pb-2 text-white">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-lg font-semibold  text-shadow-sm">
            Available Points: {availablePoints}
          </h2>
          <p className="text-sm text-ui-text-secondary text-shadow-sm">
            Level {playerLevel}
          </p>
        </div>
      </div>
      ...
      header={
        <div className="flex items-center gap-3 text-white">
          ...
          <div className="flex-1">
            <h3 className="text-base font-semibold text-ui-text-primary text-shadow-sm">
              {definition.name}
            </h3>
            <p className="text-sm text-ui-text-secondary text-shadow-sm">
      ...
      <div className="space-y-4 text-white">
        <div className="space-y-2">
          ...
          <p className="text-sm text-ui-text-secondary text-shadow-sm">
            ...
            {isMaxLevel
              ? "MAX"
              : `${definition.costPerLevel} point${definition.costPerLevel > 1 ? "s" : ""}`}
          </p>
        </div>
